...
// Query khusus untuk mengambil data pelayanan
$query_sql = "SELECT * FROM pelayanan";
...
<head>
    ...
    <title>Laporan Data Pelayanan - PMB Siti Maryam</title>
    ...
    <div class="container">
        ...
        <div class="header-laporan">
            <div class="header-title-area">
                ...
                <?php endif; ?>
                <h2><i class="fa-solid fa-file-lines" style="color: #0284c7;"></i> Laporan Data Pelayanan</h2>
            </div>
                ...
                <table>
                    <thead>
                        <tr>
                            <th>No</th>
                            <?php 
                            // Mengambil nama kolom database pelayanan secara otomatis
        ...
        <?php else: ?>
            <div class="alert">
                ...
                <span>Belum ada data pelayanan yang tersedia di database.</span>
            </div>
        <?php endif; ?>
    </div>
