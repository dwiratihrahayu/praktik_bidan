...
// Query khusus untuk mengambil data petugas
$query_sql = "SELECT * FROM petugas";
...
<head>
    ...
    <title>Laporan Data Petugas - PMB Siti Maryam</title>
    ...
    <div class="container">
        ...
        <div class="header-laporan">
            <div class="header-title-area">
                ...
                <?php endif; ?>
                <h2><i class="fa-solid fa-file-lines" style="color: #0284c7;"></i> Laporan Data Petugas</h2>
            </div>
                ...
                <table>
                    <thead>
                        <tr>
                            <th>No</th>
                            <?php 
                            // Mengambil nama kolom database petugas secara otomatis
        ...
        <?php else: ?>
            <div class="alert">
                ...
                <span>Belum ada data petugas yang tersedia di database.</span>
            </div>
        <?php endif; ?>
    </div>
